...
import com.noe.fluttermix.base.BaseActivity;
import com.noe.fluttermix.flutter.PageRouter;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView mOOpenFlutter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mOOpenFlutter = findViewById(R.id.open_flutter_o);

        mOpenNative.setOnClickListener(this);
        mOpenFlutter.setOnClickListener(this);
        mOpenFlutterFragment.setOnClickListener(this);
        mOOpenFlutter.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (v == mOOpenFlutter) {
            startActivity(
                    FlutterActivity
                            .withNewEngine()
                            .initialRoute("first")
                            .build(MainActivity.this)
                    .setClass(MainActivity.this, FlutterHostActivity.class)
            );
